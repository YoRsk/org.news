            ...
            <div class="col-lg-12">
                <div class="form-panel">
                    <label class="col-sm-2 col-sm-2 control-label" style="color: red">
                        ${result.errMes}</label>
                    <h4 class="mb"><i class="fa fa-angle-right"></i>${user.username}的资料</h4>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" id="username" name="username" value="${user.username}"
                                       onblur="checkname()"  type="text" disabled>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" id="email" name="userEmail" value="${user.userEmail}"
                                       onblur="checkemail()" <%--id="focusedInput"--%> type="text" disabled>

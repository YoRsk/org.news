            ...
            <div class="col-lg-12">
                <div class="form-panel">
                    <label class="col-sm-2 col-sm-2 control-label" style="color: red">
                        ${result.errMes}</label>
                    <h4 class="mb"><i class="fa fa-angle-right"></i>资料修改</h4>
                    <form class="form-horizontal style-form" method="post" onsubmit="return checkAll()"
                          action="${pageContext.request.contextPath}/user/toProfile">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <span class="help-block" id="tip_password">请输入新密码 6—20位</span>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" id="email" name="userEmail" value="${user.userEmail}"
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">账户类型(0:普通 1:管理员)</label>
                            <div class="col-sm-10">
                                <input class="form-control" name="userType" id="disabledInput" value="${user.userType}" type="text"
                                       disabled>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" id="age" onblur="Age()" name="userAge" class="form-control"value="${user.userAge}"
                                       placeholder="0-120">
                        ...
                        <br>
                        <button type="submit" class="btn btn-theme">修 改</button> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    </form>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <a href="${pageContext.request.contextPath}/user/center?userId=${user.userId}">
                        <button class="btn btn-theme">返 回</button>
                    </a>
                </div>
            </div>
            <!-- col-lg-12-->

<%--
  ...
  Date: 2021/3/24
  Time: 17:07
  取消了header.jsp Style样式，防止下拉式按钮样式不统一
--%>
<meta charset="utf-8">
...
<link href="${pageContext.request.contextPath}/resource/img/favicon.png" rel="icon">
<link href="${pageContext.request.contextPath}/resource/img/apple-touch-icon.png" rel="apple-touch-icon">
...
<link href="${pageContext.request.contextPath}/resource/css/bootstrap-wysihtml5/bootstrap-wysihtml5.css" rel="stylesheet" />
